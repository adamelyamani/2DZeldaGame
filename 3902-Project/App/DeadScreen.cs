...
{
    public class DeadScreen : ISprite
    {
        ...
        public DeadScreen(SpriteBatch spriteBatch, Game1 game)
        {
        ...
        public void Draw()
        {
            ...
            _spriteBatch.Begin();
            _spriteBatch.Draw(WhitePixel, coverScreen, Color.DarkRed);
            _spriteBatch.End();
            ...
            _spriteBatch.Begin();
            _spriteBatch.DrawString(_game.Font, "You Died!", new Vector2(RectangleX + RectangleWidth / 2f - 100, 150), Color.White);
